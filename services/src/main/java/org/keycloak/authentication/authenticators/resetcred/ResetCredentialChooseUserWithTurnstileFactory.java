...
public class ResetCredentialChooseUserWithTurnstileFactory implements AuthenticatorFactory {
    ...
    private static final ResetCredentialChooseUserWithTurnstile SINGLETON = new ResetCredentialChooseUserWithTurnstile();
    ...
    public String getHelpText() {
        return "Choose a user to reset credentials for with Cloudflare Turnstile CAPTCHA.";
    }
