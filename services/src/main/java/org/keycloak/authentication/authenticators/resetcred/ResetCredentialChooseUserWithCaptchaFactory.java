...
/**
 * Factory for creating ResetCredentialChooseUserWithCaptcha authenticator instances.
 * Provides a unified CAPTCHA-enabled password reset form that works with any CaptchaProvider.
 */
public class ResetCredentialChooseUserWithCaptchaFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "reset-credential-choose-user-captcha";
    ...
    public String getDisplayType() {
        return "Choose User with CAPTCHA";
    }
    ...
    public String getHelpText() {
        return "Choose a user to reset credentials for with CAPTCHA verification.";
    }
    ...
    public Authenticator create(KeycloakSession session) {
        return new ResetCredentialChooseUserWithCaptcha();
    }
