...
public class UsernamePasswordFormWithTurnstile extends UsernamePasswordForm {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        Response challengeResponse = createChallenge(context, null);
        ...
        if (context.getAuthenticatorConfig() != null) {
            ...
            if (TurnstileHelper.validateConfig(config)) {
                if (Validation.isBlank(captcha) || !validateTurnstile(context, captcha, config)) {
                    ...
                    Response challengeResponse = createChallenge(context, "turnstileFailed");
    ...
    protected Response createChallenge(AuthenticationFlowContext context, String error) {
